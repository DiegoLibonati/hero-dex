...
export const HEROE_ONE_MOCK: Hero = HEROES_MOCK[0];
export const HEROE_TWO_MOCK: Hero = HEROES_MOCK[1];
export const HEROE_THREE_MOCK: Hero = HEROES_MOCK[2];
export const HEROE_FOUR_MOCK: Hero = HEROES_MOCK[3];
